...
import { MdOutlineExplore, MdOutlineVideoLibrary, MdSubscriptions, MdOutlineWatchLater, MdDownloading } from "react-icons/md"
    ...
    <div className="container_DrawaerLeftSidebar" style={toggledrawersidebar}>
      <div className="container2_DrawaerLeftSidebar">
        ...
        <div className="libraryBtn_Drawerleftsidebar">
          ...
          <NavLink to={'/my-downloads'} className="icon_sidebar_div">
            <p>
              <MdDownloading size={22} className='icon_sidebar' style={{ margin: "auto 0.7rem" }} />
              <div className="text_sidebar_icon">My Downloads</div>
            </p>
          </NavLink>
        </div>
